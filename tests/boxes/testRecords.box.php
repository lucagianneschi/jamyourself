...
$recordBoxP3 = new RecordBox();
$recordBox3 = $recordBoxP3->initForUploadReviewPage($idRec);
print "<pre>";
print_r($recordBox3);
print "</pre>";
...
echo 'Tempo INFO RECORD REVIEW UPLOAD PAGE ' . executionTime($record3_start, $record3_stop) . '<br />';
