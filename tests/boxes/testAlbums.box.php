...
$albumBox = $albumBoxP->initForPersonalPage($objectId, $currentUserId);
print "<pre>";
print_r($albumBox);
print "</pre>";
...
$albumBox1 = $albumBoxP1->initForPersonalPage($objectId, $currentUserId);
print "<pre>";
print_r($albumBox1);
print "</pre>";
...
$albumBox2 = $albumBoxP2->initForPersonalPage($objectId, $currentUserId);
print "<pre>";
print_r($albumBox2);
print "</pre>";
...
$albumBox3 = $albumBoxP3->initForDetail($album, $currentUserId); //
print "<pre>";
print_r($albumBox3);
print "</pre>";
...
$albumBox4 = $albumBoxP4->initForDetail($album1, $currentUserId);
print "<pre>";
print_r($albumBox4);
print "</pre>";
