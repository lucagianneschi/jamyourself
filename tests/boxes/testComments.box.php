...
$commentBox = $commentBoxP->init('Album', $album, 10, 5);
print "<pre>";
print_r($commentBox);
print "</pre>";
...
$commentBox1 = $commentBoxP1->init('Comment', $comment, 10, 5);
print "<pre>";
print_r($commentBox1);
print "</pre>";
...
$commentBox2 = $commentBoxP2->init('Comment', $event, 10, 5);
print "<pre>";
print_r($commentBox2);
print "</pre>";
...
$commentBox3 = $commentBoxP3->init('Image', $image, 10, 5);
print "<pre>";
print_r($commentBox3);
print "</pre>";
...
$commentBox4 = $commentBoxP4->init('Record', $record, 10, 5);
print "<pre>";
print_r($commentBox4);
print "</pre>";
...
$commentBox5 = $commentBoxP5->init('Song', $song, 10, 5);
print "<pre>";
print_r($commentBox5);
print "</pre>";
$song_stop = microtime();
...
$commentBox6 = $commentBoxP6->init('Status', $status, 10, 5);
print "<pre>";
print_r($commentBox6);
print "</pre>";
...
$commentBox7 = $commentBoxP7->init('Video', $video, 10, 5);
print "<pre>";
print_r($commentBox7);
print "</pre>";
