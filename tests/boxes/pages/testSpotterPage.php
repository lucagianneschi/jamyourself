 ...
 * \details		carica i box di una pagina di una venue, Ultrasuono
 * \par			Commenti:
 * \warning
 * \bug
 * \todo                inserire box comment 
 *
 */
...
$relationBox = $relationBoxP->initForPersonalPage($objectId, 'SPOTTER');
print "<pre>";
print_r($relationBox);
print "</pre>";
