...
echo '<br />TEST FAQ BOX <br />';
$faqBoxP1 = new FaqBox();
$faqBox1 = $faqBoxP1->initForFaqPage(5, 'fr', 'createdAt', false);
print "<pre>";
print_r($faqBox1);
print "</pre>";
echo '<br />TEST FAQ BOX <br />';
$faqBoxP2 = new FaqBox();
$faqBox2 = $faqBoxP2->initForFaqPage(10, 'de', 'question', true);
print "<pre>";
print_r($faqBox2);
print "</pre>";
echo '<br />TEST FAQ BOX <br />';
...
echo '<br />TEST FAQ BOX <br />';
$faqBoxP4 = new FaqBox();
$faqBox4 = $faqBoxP4->initForFaqPage(1, 'es', 'createdAt', true);
print "<pre>";
print_r($faqBox4);
print "</pre>";
echo '<br />TEST FAQ BOX <br />';
