...
$notificationBox = $notificationBoxP->initForCounter($objectId, 'JAMMER');
print "<pre>";
...
$notificationBox5 = $notificationBoxP5->initForDetailedList($objectId, 'JAMMER');
print "<pre>";
print_r($notificationBox5);
print "</pre>";
echo '<br />----------------------EVENTLIST---------------------------<br />';
$notificationBoxP0 = new NotificationBox();
$notificationBox0 = $notificationBoxP0->initForEventList($objectId);
print "<pre>";
print_r($notificationBox0);
print "</pre>";
echo '<br />----------------------MESSAGELIST---------------------------<br />';
$notificationBoxP1 = new NotificationBox();
$notificationBox1 = $notificationBoxP1->initForMessageList($objectId);
print "<pre>";
