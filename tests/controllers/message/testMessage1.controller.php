...
<html>
	...
	<br />
	<button type="button" onclick="read('1xq66E2CWt')">Mark Message 1xq66E2CWt as read (set read property to true)</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="button" onclick="read('jXL9CIHVvI')">Mark Message jXL9CIHVvI as read (set read property to true)</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="button" onclick="read('WKOEVPusXY')">Mark Message WKOEVPusXY as read (set read property to true)</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="button" onclick="read('F4RUEvzr9E')">Mark Message F4RUEvzr9E as read (set read property to true)</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </body>
</html>