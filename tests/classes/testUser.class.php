...
$userParse->updateField($resSave->getObjectId(), 'active', true);
echo 'Aggiornato un campo boolean<br />';
$userParse->updateField($resSave->getObjectId(), 'address', 'Un indirizzo');
echo 'Aggiornato un campo string<br />';
$userParse->updateField($resSave->getObjectId(), 'level', 101);
echo 'Aggiornato un campo number<br />';
$userParse->updateField($resSave->getObjectId(), 'settings', array('set1', 'set2'));
...
$userParse->updateField($resSave->getObjectId(), 'geoCoding', toParseGeoPoint($parseGeoPoint));
echo 'Aggiornato un campo GeoPoint<br />';

$parseACL = new parseACL();
$parseACL->setPublicWriteAccess(false);
$userParse->updateField($resSave->getObjectId(), 'ACL', toParseACL($parseACL));
echo 'Aggiornato un campo ACL<br />';

$userParse->updateField($resSave->getObjectId(), 'collaboration', array('n1TXVlIqHw', 'WeTEWWfASn'), true, 'add', '_User');
echo 'Aggiornato (add) un campo Relation<br />';

$userParse->updateField($resSave->getObjectId(), 'collaboration', array('WeTEWWfASn'), true, 'remove', '_User');
echo 'Aggiornato (remove) un campo Relation<br />';

$userParse->updateField($resSave->getObjectId(), 'followers', array('n1TXVlIqHw', 'WeTEWWfASn'), true, 'add', '_User');
echo 'Aggiornato (add) un campo Relation<br />';

$userParse->updateField($resSave->getObjectId(), 'followers', array('WeTEWWfASn'), true, 'remove', '_User');
echo 'Aggiornato (remove) un campo Relation<br />';

$userParse->updateField($resSave->getObjectId(), 'following', array('n1TXVlIqHw', 'WeTEWWfASn'), true, 'add', '_User');
echo 'Aggiornato (add) un campo Relation<br />';

$userParse->updateField($resSave->getObjectId(), 'following', array('WeTEWWfASn'), true, 'remove', '_User');
echo 'Aggiornato (remove) un campo Relation<br />';
