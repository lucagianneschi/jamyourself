...
(function($, undefined) {
	...
	return this.queue(function() {
	    ...
	    var getBoxTimeout = 0;
	    var json_cache_object = {'set': function(id, val) {
	    ...
	    var _key = {'enter': 13, 'tab': 9, 'comma': 188, 'backspace': 8, 'leftarrow': 37, 'uparrow': 38, 'rightarrow': 39, 'downarrow': 40, 'exclamation': 33, 'slash': 47, 'colon': 58, 'at': 64, 'squarebricket_left': 91, 'apostrof': 96};
	    ...
	    var cache = {'search': function(text, callback) {
		    var temp = new Array();
