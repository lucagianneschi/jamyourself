...
(function(b, f) {
    ...
    b.jPlayer.nativeFeatures = {init: function() {
		...
		c.api = {fullscreenEnabled: !1, fullscreenElement: function() {
			return null
    ...
    b.jPlayer.prototype =
		...
		_trigger: function(a, c, d) {
			...
			if (!this.internal.ready)
			    this.internal.ready = !0, this.internal.flash.jq.css({width: "0px",
				height: "0px"}), this.version.flash = c.version, this.version.needFlash !== this.version.flash && this._error({type: b.jPlayer.error.VERSION, context: this.version.flash, message: b.jPlayer.errorMsg.VERSION + this.version.flash, hint: b.jPlayer.errorHint.VERSION}), this._trigger(b.jPlayer.event.repeat), this._trigger(a);
