    ...
    <body>
        ...
        <div id="container" style="width:50%; padding-left: 100px">
            <form id="formsignup">
                ...
                <!-- STEP 2 -->
                <div id="step2" class='step2'style="padding-left:35% ; display:none ">
                    <h3>Step 2</h3>
                ...
                <!-- STEP 3 -->
                <div id="step3" class='step3 'style="padding-left:35% ; display:none ">
                    <h3>Step 3</h3>
                ...
                <!-- STEP 4 -->
                <div id="step4" class='step4' style="padding-left:35% ; display:none ">
                    <h3>Step 4</h3>

                    <h2>Want to Tell us more about you? </h2>

                    <div>
                        <textarea rows="5" cols="40" id="description" placeholder="Let everybody know about you and the music you like"></textarea>
                    </div>
                    <div>
