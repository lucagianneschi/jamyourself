                ...
                <div  class="small-9 columns signup-box-avatar-text">							        						
                    ...
                    <div id="venue-uploadImage" class="reveal-modal uploadImage-reveal">
                        <div class="uploadImage" >
                            ...
                            <div class="row">							
                                <div id="venue_container" class="small-4 small-centered columns align-center">
                                    <div id="filelist">Upload not supported.</div>
                                    <br />
                                    <label class="uploadImage_file_label" for="venue_uploadImage_file" id="venue_uploadImage_file_label">Select a file from your computer</label>
                                </div>
                            </div>
                            <div class="row">							
