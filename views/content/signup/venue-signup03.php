...
<div id="venue-signup03" class="no-display">
		    ...
		    <div class="signup-genre">
				<?php 
					...
					foreach ($views['tag']['localType'] as $key => $value) { ?>
						<input type="checkbox" name="venue-genre[<?php echo $index ?>]" id="venue-genre[<?php echo $index ?>]" value="<?php echo $key ?>" class="no-display">
	...
	<div  class="small-8 columns">
	    <input type="button" name="venue-signup03-back" id="venue-signup03-back" class="signup-button-back" value="Go Back"/>
	    <input type="submit" name="venue-signup03-next" id="venue-signup03-next" class="signup-button" value="Complete"/>
	</div>	
    </div>
</div>