...
<div id="jammer-signup02"  class="no-display">
                    ...
                    <div class="row signup-box-image">
                        <div  class="small-3 columns signup-box-avatar">									
                            <div class="signup-image">
                                <div id="jammer_uploadImage_tumbnail-pane" class="uploadImage_tumbnail-pane"><img src="resources/images/signup/jammer.png" id="jammer_uploadImage_tumbnail" name="jammer_uploadImage_tumbnail" alt/></div>
                            </div>
                        </div>
                                ...
                                <div class="uploadImage" >
                                    ...
                                    <div class="row">							
                                        <div  class="small-10 small-centered columns align-center jammer_uploadImage_box-preview">
                                            <div id="jammer_uploadImage_preview_box">
                                                <img src="" id="jammer_uploadImage_preview" alt/>
                                    ...
                                    <div class="row">							
                                        <div  class="small-3 small-offset-9 columns">
                                            <input type="button" id="jammer_uploadImage_save" name="jammer_uploadImage_save" class="signup-button no-display uploadImage_save" value="<?php echo $views['save']; ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>							
    ...
    <div class="row">
        ...
        <div  class="small-8 columns">
            <input type="button" name="jammer-signup02-back" id="jammer-signup02-back" class="signup-button-back" value="<?php echo $views['go_back']; ?>"/>
            <input type="button" name="jammer-signup02-next" id="jammer-signup02-next" class="signup-button" value="<?php echo $views['next']; ?>"/>
        </div>	
    </div>
</div>