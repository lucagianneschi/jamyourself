...
<div id="signup-ok" class="no-display">
	...
	<div class="row signup-ok">
		...
		<label for="signup-ok-explore">
			...
			<img src="resources/images/signup/explore.png" class="img-grey " alt/>
			<img src="resources/images/signup/explore-select.png" class="img-white no-display" alt/>	
		...
		<label for="signup-ok-checkout">
		    ...
		    <img src="resources/images/signup/checkout.png" class="img-grey" alt/>
		    <img src="resources/images/signup/checkout-select.png" class="no-display img-white"alt/>	 
		...
		<label for="signup-ok-event">
		    ...
		    <img src="resources/images/signup/event.png" class="img-grey" alt/> 
		    <img src="resources/images/signup/event-select.png" class="no-display img-white" alt/>
