...
$eventObjectId = $_POST['eventObjectId'];
$limit = $_POST['limit'];
$skip = $_POST['skip'];

require_once BOXES_DIR . 'comment.box.php';
$commentBox = new CommentBox();
$commentInfoArray = $commentBox -> init('Comment', $eventObjectId, $limit, $skip);
$comments = $commentInfoArray->commentInfoArray;

?>

<!------------------------------------- comment ------------------------------------>
<div class="row" id="social-Comment <?php echo $eventObjectId ?>">
	<div  class="large-12 columns">
		...
		<div class="row ">
			<div  class="large-12 columns ">
							...
							<div class="">
								<div class="row  ">
									<div  class="small-9 columns ">
										<input id="commentEvent_<?php echo $eventObjectId; ?>" type="text" class="comment inline" placeholder="<?php echo $views['comment']['WRITE'];?>" />
									</div>
				...
				if ($commentCounter > 0 && $comments != $boxes['NODATA']) {
				...
				if ($commentCounter == 1 && $comments == $boxes['NODATA']) {
					?>
					<div class="box">	
						<div class="row">
							<div  class="large-12 columns ">
