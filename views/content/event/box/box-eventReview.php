...
$reviewBox->initForMediaPage($objectId, 'Event', $limit, $skip);
                                    ...
                                    <div class="row eventReview-propriety">
                                        <div class="box-propriety">
                                            <div class="small-6 columns ">
                                                ...
                                                <a class="note grey" onclick="loadBoxOpinion('<?php echo $review_objectId; ?>', 'Comment', '#social-EventReview-<?php echo $review_objectId; ?> .box-opinion', 10, 0)"><?php echo $views['COMM'];?></a>
