...
<ul class="small-block-grid-3 small-block-grid-2 " >	
	...
	?>
        <!------------------------------ THUMBNAIL ---------------------------------->
        <li><a class="photo-colorbox-group" href="#<?php echo $value->getObjectId(); ?>"><img class="photo" src="<?php echo $pathImage.$value->getThumbnail() ?>" onerror="this.src='<?php echo DEFIMAGE; ?>'"></a></li>
