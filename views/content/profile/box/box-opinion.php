	...
	<div  class="small-12 columns">
			...
			<div class="row  ">
				<div  class="large-12 columns ">
					<form action="" class="box-write" onsubmit="sendOpinion('<?php echo $toUser; ?>', $('#comment<?php echo $class . '_' . $objectId; ?>').val(), '<?php echo $objectId; ?>', '<?php echo $class; ?>', '<?php echo $box; ?>', '10', 0); return false;">
						<div class="">
							<div class="row  ">
