    ...
    <div class="row" id="social-Post" style='margin-bottom: 40px;'>
    	...
    	<div class="row ">
			...
			foreach ($posts as $key => $value) {
				...
				$pathPicture = USERS_DIR . $post_fromUser_objectId. '/images/profilepicturethumb/'; 
			    ?>
			    			...
			    			<div class="row  line" style="padding-bottom: 10px !important;padding-right: 20px !important;">
			    			    <div  class="small-1 columns ">
				    				<div class="icon-header">
				    				    <img src="<?php echo $pathPicture.$post_fromUser_profileThumbnail; ?>" onerror="this.src='<?php echo $defaultThum; ?>'">
				    				</div>
			    			    </div>
