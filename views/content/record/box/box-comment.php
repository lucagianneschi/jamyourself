        ...
        <div  class="large-12 columns">
            ...
            <div class="row ">
                <div  class="large-12 columns ">
                    ...
                    <div class="row  ">
                        <div  class="large-12 columns ">
                            <form action="" class="box-write" onsubmit="sendComment('<?php echo $fromUserObjectId; ?>', $('#commentRecord_<?php echo $objectId; ?>').val(), '<?php echo $objectId; ?>', 'Record', 'box-comment', '<?php echo $limit; ?>', '<?php echo $skip; ?>'); return false;">
                                <div class="">
                                    <div class="row  ">
                                        ...
                                        <div  class="small-3 columns ">
                                            <input type="button" class="post-button inline" value="Comment" onclick="sendComment('<?php echo $fromUserObjectId; ?>', $('#commentRecord_<?php echo $objectId; ?>').val(), '<?php echo $objectId; ?>', 'Record', 'box-comment', '<?php echo $limit; ?>', '<?php echo $skip; ?>')"/>
                                        </div>
                                    </div>
                                </div>
