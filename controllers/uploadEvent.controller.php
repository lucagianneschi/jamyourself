...
//utente non loggato
    ...
    public function createEvent() {
        try {
            ...
            $res_2 = $fileManager->saveEventPhoto($userId, $event->getImage());
            if (!$res_1 || !$res_2) {
...
//@TODO: inserire il nodo che rappresenta la vecchia activity
    ...
    /**
     * \fn	saveEvent()
     * \brief   funzione privata per il salvataggio nel DB di un evento
     * \param   $event
     */
