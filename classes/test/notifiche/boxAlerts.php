...
$notification1->where('active', true);
...
$notification2->where('active', true);
...
switch ($type) {
	...
	$notification3Spotter->where('active', true);
	...
	$notification3Venue->where('active', true);
	...
	$notification3Jammer->where('active', true);
