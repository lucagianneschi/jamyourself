...
class User {
     ...
     * \brief	Return an array of objectId of the User related with the User, from a parseRelation
     * \return	array
     */
    ...
    /**
     * \fn	array getCollaborationArray()
     * \brief	Return an array of objectId of the User related with the User
     * \return	array
     */
    public function getCollaborationArray() {
     ...
     * \brief	Return an array of objectId of the User who are following the User, from a parse relation
     * \return	array
     */
     ...
     * \brief	Return an array of objectId of the User related with the User, from a parse relation
     * \return	array
     */
     ...
     * \brief	Return an array of objectId of the User related with the User, from parse relation
     * \return	array
     */
    ...
    /**
     * \fn	array getFriendshipArray()
     * \brief	Return an array of objectId of the User related with the User
     * \return	array
     */
    public function getFriendshipArray() {
	return $this->friendshipArray;
    }
     ...
     * \brief	Sets an array of objectId of the User related with the User, in a parse relation
     * \param	array
     */
    ...
    /**
     * \fn	void setCollaborationArray($collaborationArray)
     * \brief	Sets an array of objectId of the User related with the User (array)
     * \param	array
     */
    public function setCollaborationArray($collaborationArray) {
	$this->collaborationArray = $collaborationArray;
    }
     ...
     * \brief	Sets an array of objectId of the User related with the User, in parse relation
     * \param	array
     */
    ...
    /**
     * \fn	void setFollowers($followersArray)
     * \brief	Sets an array of objectId of the User related with the User (array)
     * \param	array
     */
    ...
    /**
     * \fn		void setFollowing($followingArray)
     * \brief	Sets an array of objectId of the User related with the User (Array)
     * \param	array
     */
    public function setFollowingArray($followingArray) {
    ...
    /**
     * \fn	void setFriendshipArray($friendshipArray)
     * \brief	Sets an array of objectId of the User related with the User (Array)
     * \param	array
     */
    public function setFriendshipArray($friendshipArray) {
	$this->friendshipArray = $friendshipArray;
    }
	...
	if (count($this->getCollaborationArray()) != 0) {
	    foreach ($this->getCollaborationArray() as $collaboration) {
		$string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		$string .= '[collaborationID] => ' . $collaboration . '<br />';
	    }
	} else {
	    $string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	    $string .= '[collaborationArray] => NULL<br />';
	}
	...
	if (count($this->getFollowersArray()) != 0) {
	    foreach ($this->getFollowersArray() as $follower) {
		$string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		$string .= '[followerID] => ' . $follower . '<br />';
	    }
	} else {
	    $string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	    $string .= '[followerArray] => NULL<br />';
	}
	...
	if (count($this->getFollowingArray()) != 0) {
	    foreach ($this->getFollowingArray() as $following) {
		$string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		$string .= '[followingID] => ' . $following . '<br />';
	    }
	} else {
	    $string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	    $string .= '[followingArray] => NULL<br />';
	}
	...
	if (count($this->getFriendshipArray()) != 0) {
	    foreach ($this->getFriendshipArray() as $friendship) {
		$string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		$string .= '[friendshipID] => ' . $friendship . '<br />';
	    }
	} else {
	    $string .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	    $string .= '[friendshipArray] => NULL<br />';
	}
