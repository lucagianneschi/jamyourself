...
class RecordParse {
    ...
    function parseToRecord($res) {
        ...
        try {
            ...
            $record->setLocationName(parse_decode_string($res->locationName));
    ...
    function saveRecord($record) {
        ...
        try {
            ...
            is_null($record->getCommentCounter()) ? $parseObject->commentCounter = 0 : $parseObject->commentCounter = $record->getCommentCounter();
            ...
            is_null($record->getDescription()) ? $parseObject->description = null : $parseObject->description = parse_encode_string($record->getDescription());
            ...
            is_null($record->getLabel()) ? $parseObject->label = null : $parseObject->label = parse_encode_string($record->getLabel());
            is_null($record->getLocation()) ? $parseObject->location = null : $parseObject->location = toParseGeoPoint($record->getLocation());
            is_null($record->getLocationName()) ? $parseObject->locationName = null : $parseObject->locationName = parse_encode_string($record->getLocationName());
            ...
            is_null($record->getTitle()) ? $parseObject->title = null : $parseObject->title = parse_encode_string($record->getTitle());
