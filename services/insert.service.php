 ...
 * @todo
 */
function insertUser($connection, User $user) {
    $startTimer = microtime();
    $sql = "INSERT INTO user (id,
				  ...
				  '" . $user->getUsername() . "',
                                  ...
                                  '" . $user->getCity() . "',
                                  '" . (is_null($user->getCollaborationcounter()) ? 0 : $user->getCollaborationcounter()) . "',
                                  '" . $user->getCountry() . "',
                                  '" . $user->getDescription() . "',
                                  '" . $user->getEmail() . "',
                                  '" . $user->getFacebookId() . "',
                                  '" . $user->getFacebookpage() . "',
                                  '" . $user->getFirstname() . "',
                                  '" . (is_null($user->getFollowerscounter()) ? 0 : $user->getFollowerscounter()) . "',
                                  '" . (is_null($user->getFollowingcounter()) ? 0 : $user->getFollowingcounter()) . "',
                                  '" . (is_null($user->getFriendshipcounter()) ? 0 : $user->getFriendshipcounter()) . "',
                                  '" . $user->getGooglepluspage() . "',
                                  '" . (is_null($user->getJammercounter()) ? 0 : $user->getJammercounter()) . "',
                                  '" . $user->getJammertype() . "',
                                  '" . $user->getLastname() . "',
                                  '" . (is_null($user->getLevel()) ? 0 : $user->getLevel()) . "',   
                                  '" . (is_null($user->getLevelvalue()) ? 0 : $user->getLevelvalue()) . "', 
				  ...
				  '" . (is_null($user->getPremiumexpirationdate()) ? 0 : $user->getPremiumexpirationdate()) . "', 
                                  ...
                                  '" . $user->getTwitterpage() . "',
                                  '" . $user->getType() . "',
                                  '" . (is_null($user->getVenuecounter()) ? 0 : $user->getVenuecounter()) . "',    
                                  '" . $user->getWebsite() . "',
